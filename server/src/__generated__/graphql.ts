...
export type TodoListConnectionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TodoListConnection'] = ResolversParentTypes['TodoListConnection']> = ResolversObject<{
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>,
  edges?: Resolver<Array<Maybe<ResolversTypes['TodoListEdge']>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn,
}>;

export type TodoListEdgeResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TodoListEdge'] = ResolversParentTypes['TodoListEdge']> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
  node?: Resolver<Maybe<ResolversTypes['TodoList']>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn,
}>;

export type TodoListItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TodoListItem'] = ResolversParentTypes['TodoListItem']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
...
export type TodoListItemConnectionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TodoListItemConnection'] = ResolversParentTypes['TodoListItemConnection']> = ResolversObject<{
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>,
  edges?: Resolver<Array<Maybe<ResolversTypes['TodoListItemEdge']>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn,
}>;

export type TodoListItemEdgeResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TodoListItemEdge'] = ResolversParentTypes['TodoListItemEdge']> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
